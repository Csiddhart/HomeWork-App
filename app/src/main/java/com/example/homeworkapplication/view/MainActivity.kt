...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.fab.setOnClickListener { view ->
            Snackbar.make(view, "Here we are seeing the Data passing in between Fragments with use of View-Model &" +
                    " Image Fetching using Glide Library", Snackbar.LENGTH_LONG)
